...
import AllStatesOverview from './all-states';
...
const render = props => (
  <div className="cms dashboard">
    ...
    <Route exact path={`${props.match.path}/all`} component={AllStatesOverview} />
    <Route exact path={`${props.match.path}/state/:state`} component={StateOverview} />
